...
class WinesControllerTest < ActionController::TestCase
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post :create, wine: { name: @wine.name, photo: @wine.photo, price: @wine.price, purchased: @wine.purchased, varietal: @wine.varietal, vineyard_id: @wine.vineyard_id, vintage: @wine.vintage }
    end
  ...
  test "should update wine" do
    put :update, id: @wine, wine: { name: @wine.name, photo: @wine.photo, price: @wine.price, purchased: @wine.purchased, varietal: @wine.varietal, vineyard_id: @wine.vineyard_id, vintage: @wine.vintage }
    assert_redirected_to wine_path(assigns(:wine))
  end
